...
import pic from "../assets/images/hospital.png";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="flex justify-center">
                            <div className="bg-blue-200 rounded-2xl w-full max-w-md h-80 flex items-center justify-center overflow-hidden">

                                <img
                                    src={pic}
                                    alt="Twilight HealthCare Hospital"
                                    className="rounded-2xl w-full max-w-md h-80 flex items-center justify-center overflow-hidden"
                                />
